...
g_.getCssValue_ = function (selector, property, toInteger = false) {
    let theCssValue = getComputedStyle($_(selector)).getPropertyValue(property);
    ...
    if (toInteger) {
        ...
        if (varUnit === "px") theCssValue = parseInt(theCssValue);
        else theCssValue = parseFloat(theCssValue);
    }
...
g_.transitionListener_ = function ({
    ...
    const start = () => {
        ...
        if (cbWhile) requestID = window.requestAnimationFrame(loop);
    };
...
g_.makeHtmlRequestQuery_ = function () {
    ...
    for (let i = 0; i < keys.length; i++) {
        const value = maybeArrayStringify_(requestParameters[keys[i]]);
...
g_.maybeArrayStringify_ = function (input) {
    if (Array.isArray(input)) input = JSON.stringify(input);
...
´ ´ ´ ´ ´ ´ ´ ´ ´ ´ ´ ´ ´ ´ ´ ´ ´ ´ ´ ´ ´ ´ ´ ´ ´ ´ ´ ´ ´ ´ ´ ´ ´ ´ ´ ´ ´ ´*/
        switch (_char) {
            ...
            case " ":
                if (bypass) addChunk = _char;
                else if (lastChar !== " ") addChunk = " ";
                cache = "";
                break;
...
g_.createId = function createId(prefix = "i") {
    return `${prefix}-${Math.ceil(
...
Object.defineProperty(Object.prototype, "keys_", {
    value: function () {
        let that = this;
...
Object.defineProperty(Object.prototype, "isObject_", {
...
Object.defineProperty(Object.prototype, "isEmpty_", {
    value: function () {
        ...
        if (Object.keys(this).length) isEmpty = false;

        return isEmpty;
    },
});

Object.defineProperty(Object.prototype, "asOneString_", {
    value: function () {
        let theString = "";
        ...
        if (that.name === "Object")
            if (args.object) that = args.object;
            else if (arguments.length === 1 && Object.isObject_(args))
                that = args;
        ...
        if (reverse) {
            ...
            for (let i = 0; i < keys.length; i++) {
                ...
                if (i !== keys.length - 1) theString += separation;
            }
        } else {
...
Object.defineProperty(Object.prototype, "deepCopy_", {
    value: function (input) {
...
Object.defineProperty(Array.prototype, "last_", {
    value: function () {
        let theLast = null;

        if (this.length) theLast = this[this.length - 1];

        return theLast;
    },
});

Object.defineProperty(Array.prototype, "equals_", {
...
Object.defineProperty(Array.prototype, "intersects_", {
    value: function (otherArray) {
...
Object.defineProperty(Array.prototype, "forEachAS_", {
    value: function (callback) {
        if (typeof callback === "function")
            this.forEach((_item) => setTimeout(callback(_item), 0));
        else throw "Expects argument to be a function.";
    },
});

Object.defineProperty(Array.prototype, "closestValue_", {
    value: function (input) {
        ...
        if (
            ...
            theValue = arr[i];
        else theValue = arr[i + 1];

        return theValue;
    },
});

Object.defineProperty(String.prototype, "splitAsInt_", {
    value: function () {
        let that = this;

        if (this.name === "String" && arguments[0]) that = arguments[0];
        ...
        that.forEach((_number) => {
            if (parseInt(_number)) numberized.push(parseInt(_number));
        });
...
Object.defineProperty(Map.prototype, "getByIndex_", {
...
Object.defineProperty(Object.prototype, "ofDOM_", {
    value: function (that) {
        if (
            that !== window &&
            that !== document &&
...
Object.defineProperty(Object.prototype, "addClass_", {
    value: function () {
        const that = Object.ofDOM_(this);

        if (that !== null) that.classList.add(...arguments);

        return that;
    },
});

Object.defineProperty(Object.prototype, "removeClass_", {
    value: function () {
        const that = Object.ofDOM_(this);

        if (that !== null) that.classList.remove(...arguments);

        return that;
    },
});

Object.defineProperty(Object.prototype, "replaceClass_", {
    value: function () {
        const that = Object.ofDOM_(this);
...
Object.defineProperty(Object.prototype, "hasClass_", {
    value: function () {
        let hasClass = null;
        const that = Object.ofDOM_(this);

        if (that) hasClass = that.classList.contains(...arguments);
...
Object.defineProperty(Object.prototype, "$_", {
    value: function () {
        ...
        if (that) $ = that.querySelector(...arguments);

        return $;
    },
});

Object.defineProperty(Object.prototype, "$all_", {
    value: function () {
        let $all = null;
        const that = Object.ofDOM_(this);

        if (that) $all = that.querySelectorAll(...arguments);
...
Object.defineProperty(Object.prototype, "rememberListener_", {
    value: function (properties) {
        ...
        if ($element) {
            ...
            if (cached.has($element)) {
                ...
                if (_entry[ID]) $element.forgetListener_(ID);
...
Object.defineProperty(Object.prototype, "forgetListener_", {
    value: function (ID) {
        const $element = Object.ofDOM_(this);
        const cached = g_.CACHE_.listener;

        if ($element && cached.has($element) && cached.get($element)[ID]) {
            const _entry = cached.get($element);
            ...
            if (Object.keys(_entry).length === 0) cached.delete($element);
            else cached.set($element, _entry);
        }
...
Object.defineProperty(Object.prototype, "prepareEventListener_", {
        ...
        const properties = {
            ...
            callback: (e) => {
                if (
                    ...
                    (e instanceof TouchEvent && e.eventPhase > 0) ||
                    // Safari fix:
                    (e.type.includes("touch") && e.eventPhase > 0)
                ) {
                    userCallback(e);
                    if (properties.spread === false) e.stopPropagation();
                }
            },
        };
...
Object.defineProperty(Object.prototype, "saneEventListener_", {
...
Object.defineProperty(Object.prototype, "onClick_", {
...
Object.defineProperty(Object.prototype, "onHit_", {
    value: function (callback, args = {}) {
        const $element = Object.ofDOM_(this);
...
Object.defineProperty(Object.prototype, "onRelease_", {
    value: function (callback, args = {}) {
        const $element = Object.ofDOM_(this);
...
Object.defineProperty(Object.prototype, "onEnter_", {
    value: function (callback, args = {}) {
        const $element = Object.ofDOM_(this);
...
Object.defineProperty(Object.prototype, "onLeave_", {
    value: function (callback, args = {}) {
        const $element = Object.ofDOM_(this);
...
Object.defineProperty(Object.prototype, "onMove_", {
    value: function (callback, args = {}) {
        const $element = Object.ofDOM_(this);
...
// or touchmove:
Object.defineProperty(Object.prototype, "onDrag_", {
    value: function (callback, args = {}) {
        const $element = Object.ofDOM_(this);
...
Object.defineProperty(Object.prototype, "onHover_", {
    value: function (callback, args = {}) {
        const $element = Object.ofDOM_(this);
...
Object.defineProperty(Object.prototype, "defineClick_", {
    value: function (cb = {}, context = null) {
        ...
        if ($element) {
            ...
            const start = (e) => {
                ...
                if (
                    (e instanceof TouchEvent && e.cancelable === true) ||
                    // Safari fix:
                    (e.type.includes("touch") && e.cancelable === true)
                )
                    e.preventDefault();
                ...
                window.onDrag_((e) => cb.drag.call(context, e), {
                    ID: "defineClick_drag",
                });
...
Object.defineProperty(Object.prototype, "onWheel_", {
    value: function (callback, args = {}) {
        const $element = Object.ofDOM_(this);
...
Object.defineProperty(Object.prototype, "onKey_", {
    value: function (callback, args = {}) {
        const $element = Object.ofDOM_(this);
...
Object.defineProperty(Object.prototype, "onResize_", {
    value: function (callback, args = {}) {
        const $element = Object.ofDOM_(this);
...
Object.defineProperty(Object.prototype, "transition_", {
    value: function (classList, callback) {
        const $element = Object.ofDOM_(this);

        if ($element && classList && callback) {
...
*/
    const Scroll_ = {
        ...
        setPosition(newPosY) {
            if (newPosY < this.tolerance) Event_.fire(window, "pagestart_");
            else if (newPosY > this.maxScroll() - this.tolerance)
        ...
        disable() {
            document.onWheel_((e) => e.preventDefault(), {
                ID: "no-wheel",
                passive: false,
            });
        },
        ...
        init() {
            ...
            document.saneEventListener_("scroll", () => this.onScroll());
