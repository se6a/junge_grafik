const InputText = getSnippet("input-text-short");
...
module.exports = () => {
    ...
    <form class="NewsletterForm form" action="https://jungegrafik.us12.list-manage.com/subscribe/post?u=1b116b67c6aa316931ff78114&amp;id=14e5482c54&amp;f_id=00b343e0f0" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
            ...
            <div class="formField TextShort --required">
                <div class="inputBox">
                    <input id="mce-FNAME" class="input TextShort valid" name="FNAME" type="text" maxlength="150" required="" placeholder="Your Firstname" aria-required="true">
                </div>
            </div>

            <div class="formField TextShort --required">
                <div class="inputBox">
                    <input id="mce-LNAME" class="input TextShort valid" name="LNAME" type="text" maxlength="150" required="" placeholder="Your Lastname" aria-required="true">
                </div>
            </div>
