...
module.exports = (data) => {
          ...
          },
          {
            ...
            content: `
              <ul>
                ...
                <li class="arrow">
                  Works created between 01.01.2019 and the end of the entry period will be judged. Participation is only possible within the entry period.
                </li>
                <li class="arrow">
          ...
          },
          {
            ...
            content: `
              <ul>
                ...
                <li class="arrow">The winners will receive at least CHF 400 prize money and various material prizes. They will also be recognized in the publication, on the website, in the traveling exhibition and at the award ceremony. </li>
  ...
  const css = splitTemp/*css*/`
    ...
    .VIEW.Consentement .HEADER-VIEW {
      min-height: 50vh;
    }
  `;

  return ["consentement.view", html, css];
};
